  ...
  <div class="navbar-inner">
    <div class="container">
      ...
      <div class="nav-collapse collapse">
        <ul class="nav">
          <li class="">
            <a href="index.php#services"><i class="icon-lightbulb"></i>Services</a>
          </li>
          <li class="">
            <a href="index.php#portfolio"><i class="icon-picture"></i>Portfolio</a>
          </li>
           <li class="">
            <a href="index.php#about-us"><i class="icon-comment-alt"></i>About us</a>
          </li>
          <li class="">
            <a href="index.php#blog"><i class="icon-file-alt"></i>Blog</a>
          </li>
          <li class="">
            <a href="index.php#contact"><i class="icon-envelope"></i>Contact us</a>
          </li>
        </ul>
      </div>
    </div>
